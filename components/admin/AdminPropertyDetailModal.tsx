...
import { X, MapPin, Bed, Bath, Maximize, Phone } from 'lucide-react';
                ...
                >
                    ...
                    <div className="p-6 space-y-6">
                        ...
                        <div className="grid grid-cols-2 gap-3 pt-2">
                            <div>
                                <span className="text-[10px] text-neutral-400 uppercase tracking-wider">Tên dự án</span>
                            ...
                            <div>
                                ...
                                <p className={`text-sm font-medium ${property.saleStatus === 'da_ban'
                                        ? 'text-rose-600'
                                        : 'text-emerald-600'
                                    }`}>
