                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-1.5">
                            ...
                            <select
                                ...
                                className="w-full bg-neutral-50 dark:bg-neutral-900/50 border border-neutral-200 dark:border-neutral-800 p-2 text-xs tracking-widest uppercase focus:outline-none cursor-pointer text-neutral-900 dark:text-neutral-100 bg-white dark:bg-neutral-900"
                            >
