            ...
            {showFilter && (
                <div className="border border-neutral-200 dark:border-neutral-900 bg-white dark:bg-neutral-950 p-6 space-y-6 animate-in slide-in-from-top-5 duration-200">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6" onKeyDown={handleKeyDown}>
                        ...
                        {/* Boolean Filters - Pháp lý
                        <div className="space-y-2 md:col-span-2 lg:col-span-3">
                            <label className="text-[10px] font-bold tracking-widest text-neutral-400 uppercase flex items-center gap-1">
                                <Shield className="w-3 h-3" /> PHÁP LÝ & TIỆN ÍCH
                            </label>
                            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
                                <label className="flex items-center gap-2 text-[10px] cursor-pointer">
                                    <input
                                        type="checkbox"
                                        checked={localFilters.hasConstructionApproval || false}
                                        onChange={e => setLocalFilters(prev => ({ 
                                            ...prev, 
                                            hasConstructionApproval: e.target.checked || undefined 
                                        }))}
                                        className="w-4 h-4"
                                    />
                                ...
                                <label className="flex items-center gap-2 text-[10px] cursor-pointer">
                                    <input
                                        type="checkbox"
                                        checked={localFilters.hasBuildingPermit || false}
                                        onChange={e => setLocalFilters(prev => ({ 
                                            ...prev, 
                                            hasBuildingPermit: e.target.checked || undefined 
                                        }))}
                                        className="w-4 h-4"
                                    />
                                    <span className="flex items-center gap-1">
                                ...
                                <label className="flex items-center gap-2 text-[10px] cursor-pointer">
                                    <input
                                        type="checkbox"
                                        checked={localFilters.isInExistingResidentialArea || false}
                                        onChange={e => setLocalFilters(prev => ({ 
                                            ...prev, 
                                            isInExistingResidentialArea: e.target.checked || undefined 
                                        }))}
                                        className="w-4 h-4"
                                    />
                                    <span className="flex items-center gap-1">
                                ...
                                <label className="flex items-center gap-2 text-[10px] cursor-pointer">
                                    <input
                                        type="checkbox"
                                        checked={localFilters.hasCashFlow || false}
                                        onChange={e => setLocalFilters(prev => ({ 
                                            ...prev, 
                                            hasCashFlow: e.target.checked || undefined 
                                        }))}
                                        className="w-4 h-4"
                                    />
                                    <span className="flex items-center gap-1">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-3 gap-2 mt-1">
                                <label className="flex items-center gap-2 text-[10px] cursor-pointer">
                                    <input
                                        type="checkbox"
                                        checked={localFilters.hasPlanningIssue || false}
                                        onChange={e => setLocalFilters(prev => ({ 
                                            ...prev, 
                                            hasPlanningIssue: e.target.checked || undefined 
                                        }))}
                                        className="w-4 h-4"
                                    />
                                ...
                                <label className="flex items-center gap-2 text-[10px] cursor-pointer">
                                    <input
                                        type="checkbox"
                                        checked={localFilters.hasRoadWidthIssue || false}
                                        onChange={e => setLocalFilters(prev => ({ 
                                            ...prev, 
                                            hasRoadWidthIssue: e.target.checked || undefined 
                                        }))}
                                        className="w-4 h-4"
                                    />
                                    <span className="flex items-center gap-1 text-amber-600">
